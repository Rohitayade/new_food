...
<body class="home">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="https://wallpaperaccess.com/full/6129790.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Khushi Food Ordering</h1>
                    <h5 class="font-white space-xs">Healthy and Tasty food available here !</h5>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            ...
                            <h5>Call us at: <a href="tel:+914450005500">+91 00 00000000</a></h5></div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>About us ?</h5>
                            <p>A simple way for students to place online food order !</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
